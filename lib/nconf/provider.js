...
//
// ### function Set (pairs)
// #### @pairs {object} an object containing key:value pairs that will be added
// Same as the set function, however it accepts an object of key:value pairs. Use it for batch insertion
//
Provider.prototype.Set = function (pairs, callback) {
	var pair = pairs[0];
  var that = this;	
	// For each pair in pairs, invoke the set function
	for(var key in pair){
		var value = pair[key];
    that.set(key,value);
	}
