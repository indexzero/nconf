...
var File = module.exports = function (options) {
  if (!(this instanceof File)) { return new File(options); }
...
File.prototype.save = function (value, callback) {
  ...
  fs.writeFile(this.file, this.format.stringify(this.store, null, this.spacing), function (err) {
...
File.prototype.saveSync = function (value) {
  try {
    fs.writeFileSync(this.file, this.format.stringify(this.store, null, this.spacing));
  }
  catch (ex) {
    throw(ex);
  }
  ...
  exists(self.file, function (exists) {
    ...
    fs.readFile(self.file, function (err, data) {
      ...
      try {
        ...
        stringData = stringData.charAt(0) === '\uFEFF'
          ? stringData.substr(1)
          : stringData;
